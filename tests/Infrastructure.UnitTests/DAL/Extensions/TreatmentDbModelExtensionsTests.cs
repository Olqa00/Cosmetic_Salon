...
[TestClass]
public sealed class TreatmentDbModelExtensionsTests
{
    ...
    public TreatmentDbModelExtensionsTests()
    {
    ...
    [TestMethod]
    public void ToEntities_Should_ReturnTreatmentEntities()
    {
        // Arrange
        ...
        // Act
        var result = TREATMENT_DB_MODELS.ToEntities(users);

        // Assert
        result.Should()
            .BeEquivalentTo(treatmentEntities)
            ;
    }

    [TestMethod]
    public void ToEntity_Should_ReturnTreatmentEntity()
    {
        // Arrange
        var users = new List<UserEntity>
        {
        ...
        // Act
        var entity = TREATMENT_DB_MODEL.ToEntity(users);
